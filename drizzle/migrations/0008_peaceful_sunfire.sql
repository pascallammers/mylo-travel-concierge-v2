...
CREATE TABLE "session_states" (
	...
	"state" json NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "session_states_chat_id_unique" UNIQUE("chat_id")
);
--> statement-breakpoint
CREATE TABLE "tool_calls" (
	...
	CONSTRAINT "tool_calls_dedupe_key_unique" UNIQUE("dedupe_key")
);
--> statement-breakpoint
...
ALTER TABLE "session_states" ADD CONSTRAINT "session_states_chat_id_chat_id_fk" FOREIGN KEY ("chat_id") REFERENCES "public"."chat"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_calls" ADD CONSTRAINT "tool_calls_chat_id_chat_id_fk" FOREIGN KEY ("chat_id") REFERENCES "public"."chat"("id") ON DELETE cascade ON UPDATE no action;