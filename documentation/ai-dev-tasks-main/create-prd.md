...
4.  **Save PRD:** Save the generated document as `prd-[feature-name].md` inside the `/tasks` directory. Put in in a directory with the actual date from today `YYYY-MM-DD`
