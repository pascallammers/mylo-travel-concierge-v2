...
- 0.5h - 1.5h: round to 0.5 increments, return "~Xh Fahrt" (use comma for German: "~1,5h Fahrt")
...
TypeScript compilation passes: `npx tsc --noEmit`
  ...
  <done>
formatFlightErrorWithAlternatives({ type: 'no_results', message: 'test', alternatives: [{code: 'HHN', name: 'Frankfurt-Hahn', city: 'Hahn', distance: '~1.5h Fahrt'}] }) returns properly formatted German string with inline alternatives
  </done>
</task>
...
- Drive times formatted as "~Xh Fahrt" not kilometers
