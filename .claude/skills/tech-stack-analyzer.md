...
- **Missing standards** (.claude/standards/ directory empty)
...
For each detected framework/language, create a standards file in `.claude/standards/`:
...
**Save to:** `.claude/standards/react.md`
...
**Save to:** `.claude/standards/typescript.md`
...
**Save to:** `.claude/standards/security.md`
...
This project uses:
${detectedFrameworks.map(f => \`- **\${f}:** See [.claude/standards/\${f}.md](.claude/standards/\${f}.md)\`).join('\n')}

**Language Standards:**
${detectedLanguages.map(l => \`- **\${l}:** See [.claude/standards/\${l}.md](.claude/standards/\${l}.md)\`).join('\n')}

**Security:** See [.claude/standards/security.md](.claude/standards/security.md)
...
**Next Steps:**
1. Review generated standards in .claude/standards/
...
3. Create: .claude/standards/react.md
4. Create: .claude/standards/typescript.md
5. Create: .claude/standards/security.md
6. Update: CLAUDE.md
