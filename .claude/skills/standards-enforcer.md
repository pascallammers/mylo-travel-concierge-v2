...
const standards = [
  ...
  '.claude/standards/security.md' // Extra emphasis on security
];
```
...
Standard: .claude/standards/react.md - Custom Hooks
...
Standard: .claude/standards/security.md - SQL Injection Prevention
Severity: CRITICAL
...
Standard: .claude/standards/typescript.md - Avoid `any`
...
Teams can customize enforcement levels in `.claude/config.json`:
