...
2. **Creates Backup** (if --checkpoint)
   - Saves full conversation state to `.claude/.checkpoints/`
...
3. **Applies Hierarchical Optimization**
   ...
   - **Archive:** Important decisions to `.claude/memory/`
...
1. Creating checkpoint...
   ✅ Saved to .claude/.checkpoints/optimization-2025-11-11-21-30-45.json
...
6. Archiving to memory...
   ✅ 3 decisions → .claude/memory/org/decisions.json
   ✅ 2 patterns → .claude/memory/org/patterns.json
