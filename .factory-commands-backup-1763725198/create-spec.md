...
Creates file: `.factory/specs/active/[name].md`
...
3. **Validate**: `/validate-spec .factory/specs/active/auth-system.md`
4. **Convert to tasks**: `/spec-to-tasks .factory/specs/active/auth-system.md`
...
#    2. Run /validate-spec .factory/specs/active/user-dashboard.md
#    3. Run /spec-to-tasks .factory/specs/active/user-dashboard.md
```
...
<execute>
SPECS_DIR="${DROID_PROJECT_DIR:-${CLAUDE_PROJECT_DIR:-$(pwd)}}/.factory/specs"
