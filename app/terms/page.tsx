    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:text-foreground/80 prose-headings:tracking-tight">
          <p className="text-lg">
            Welcome to MYLO - Dein Travel-Concierge. These Terms of Service govern your use of our website and services. By using MYLO - Dein Travel-Concierge,
          ...
          <p>
            By accessing or using MYLO - Dein Travel-Concierge, you acknowledge that you have read, understood, and agree to be bound by
            these Terms of Service. We reserve the right to modify these terms at any time, and such modifications shall
            be effective immediately upon posting. Your continued use of MYLO - Dein Travel-Concierge after any modifications indicates your
            acceptance of the modified terms.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            MYLO - Dein Travel-Concierge is a minimalistic AI-powered search engine that helps users find information on the internet. Our
          ...
          <p>You agree not to use MYLO - Dein Travel-Concierge to:</p>
          <ul>
          ...
          <p>While we strive to provide accurate and reliable information, MYLO - Dein Travel-Concierge:</p>
          <ul>
          ...
          <p>
            ...
            MYLO - Dein Travel-Concierge should not be used as the sole source for making important decisions, especially in professional,
            medical, legal, or financial contexts.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            All content, features, and functionality of MYLO - Dein Travel-Concierge, including but not limited to text, graphics, logos,
            icons, images, audio clips, and software, are the property of MYLO - Dein Travel-Concierge or its licensors and are protected by
          ...
          <p>MYLO - Dein Travel-Concierge relies on third-party services to provide its functionality:</p>
          <ul>
          ...
          <p>
            By using MYLO - Dein Travel-Concierge, you acknowledge and agree that your data may be processed by these third-party services
          ...
          <p>
            MYLO - Dein Travel-Concierge offers both free and paid subscription plans. For detailed pricing information, visit our{' '}
          ...
          <ul>
            ...
            <li>
              <strong>MYLO Pro:</strong> $15/month subscription with unlimited searches and access to all AI models
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Important:</strong> MYLO - Dein Travel-Concierge does not store any payment card details, bank information, or other
          ...
          <h2>9. Privacy</h2>
          <p>
            Your use of MYLO - Dein Travel-Concierge is also governed by our{' '}
          ...
          <p>
            To the maximum extent permitted by law, MYLO - Dein Travel-Concierge shall not be liable for any indirect, incidental, special,
          ...
          <p>
            MYLO - Dein Travel-Concierge is provided &quot;as is&quot; and &quot;as available&quot; without any warranties of any kind,
          ...
          <p>
            We reserve the right to suspend or terminate your access to MYLO - Dein Travel-Concierge, with or without notice, for conduct
          ...
          <p>
            ...
            MYLO - Dein Travel-Concierge operates, without regard to its conflict of law provisions.
          </p>
          ...
          <div className="my-8 border-t pt-8">
            <p className="text-sm text-muted-foreground">
              By using MYLO - Dein Travel-Concierge, you agree to these Terms of Service and our{' '}
              <Link href="/privacy-policy" className="underline">
                Privacy Policy
              </Link>
              .
