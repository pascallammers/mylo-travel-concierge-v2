...
4. **Generates Standards Files**
   - `.factory/standards/react.md` (if React detected)
   - `.factory/standards/typescript.md` (if TypeScript detected)
   - `.factory/standards/security.md` (always)
   - `.factory/standards/testing.md` (based on test framework)
...
Next Steps:
1. Review generated standards: ls .factory/standards/
2. Customize as needed: edit .factory/standards/*.md
